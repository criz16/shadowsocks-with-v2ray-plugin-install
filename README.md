...
# Installation
## CentOS 7/8
wget -O centos-ss-install.sh https://raw.githubusercontent.com/criz16/shadowsocks-with-v2ray-plugin-install/master/centos-ss-install.sh
chmod +x centos-ss-install.sh
./centos-ss-install.sh

## Ubuntu 18.04/16.04 or Debian 9/10
wget -O ubuntu-ss-install.sh https://raw.githubusercontent.com/criz16/shadowsocks-with-v2ray-plugin-install/master/ubuntu-ss-install.sh
